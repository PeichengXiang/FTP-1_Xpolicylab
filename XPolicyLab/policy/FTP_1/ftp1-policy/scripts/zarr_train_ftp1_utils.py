...
from openpi.policies.ftp1_checkpoint_compat import apply_tied_paligemma_embedding_fallback
from openpi.policies.ftp1_checkpoint_compat import classify_unexpected_checkpoint_keys
from openpi.policies.ftp1_checkpoint_compat import summarize_checkpoint_load
    ...
    *,
    ...
    try:
        if allow_partial_load:
            ...
            missing_keys = apply_tied_paligemma_embedding_fallback(
                model_to_load, list(load_result.missing_keys)
            )
            expected_unused_keys, unexpected_keys = classify_unexpected_checkpoint_keys(
                model_to_load, list(load_result.unexpected_keys)
            )
            summarize_checkpoint_load(missing_keys, unexpected_keys, expected_unused_keys)
